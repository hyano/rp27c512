...
* **RP27C512**の基板を流用して、ROMを**RP27C512**に接続するための子基板も作ることができます。
...
* ショットキーバリアダイオードを基板に取り付けます。
  ...
  * ダイオードの太さによってはAE-RP2040と接触しますが、気にしません。
* 丸ピンIC用連結ヘッダを基板に取り付けます。
  * 次に取り付けるロープロファイルピンヘッダーも基板に固定した状態でハンダ付けするとよいでしょう。
...
* ロープロファイルピンヘッダーにAE-RP2040を取り付けます。
  * 後からQIコネクタを取り付けられるスペースを残すよう、QIコネクタを取り付けた状態でハンダ付けするとよいでしょう。
  * 子基板を使用する場合、ハンダが上方にあると子基板のピンソケットに刺さりません。
    スルーホール付近にだけハンダが乗るようにします。多くつき過ぎた場合は、ハンダ吸い取り線で除去するとよいでしょう。

### 組み立て(子基板)

cloneモードでROMを接続しやすくするための基板です。

* スズメッキ線をダイオードの代わりにD1に取り付けます。
* ICソケットを取り付けます。
  * 次に取り付けるシングルピンソケットも基板に固定した状態でハンダ付けするとよいでしょう。
